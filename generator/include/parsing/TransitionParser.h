...
public:
     ...
     */
    explicit TransitionParser(::std::shared_ptr<::SCXML::Model::INodeFactory> nodeFactory);
     ...
     * @return 생성된 전환 노드
     */
    ::std::shared_ptr<::SCXML::Model::ITransitionNode> parseTransitionNode(const xmlpp::Element *transElement,
     ...
     * @return 생성된 전환 노드
     */
    ::std::shared_ptr<::SCXML::Model::ITransitionNode> parseInitialTransition(const xmlpp::Element *initialElement);
    ...
    parseTransitionsInState(const xmlpp::Element *stateElement, ::SCXML::Model::IStateNode *stateNode);
...
private:
     ...
     */
    void parseActions(const xmlpp::Element *transElement, ::std::shared_ptr<::SCXML::Model::ITransitionNode> transition);
