...
public:
     ...
     */
    explicit DocumentParser(::std::shared_ptr<::SCXML::Model::INodeFactory> nodeFactory,
                            ::std::shared_ptr<::SCXML::Model::IXIncludeProcessor> xincludeProcessor = nullptr);
     ...
     */
    ::std::shared_ptr<::SCXML::Model::DocumentModel> parseFile(const ::std::string &filename);
     ...
     * @return 파싱된 SCXML 모델, 실패 시 nullptr
     */
    ::std::shared_ptr<::SCXML::Model::DocumentModel> parseContent(const ::std::string &content);
     ...
     * @return 상태 노드 파서
     */
    ::std::shared_ptr<SCXML::Parsing::StateNodeParser> getStateNodeParser() const {
     ...
     */
    ::std::shared_ptr<::SCXML::Model::IXIncludeProcessor> getXIncludeProcessor() const {
...
private:
     ...
     * @return 파싱된 SCXML 모델, 실패 시 nullptr
     */
    ::std::shared_ptr<::SCXML::Model::DocumentModel> parseDocument(xmlpp::Document *doc);
     ...
     * @return 성공 여부
     */
    bool parseScxmlNode(const xmlpp::Element *scxmlNode, ::std::shared_ptr<::SCXML::Model::DocumentModel> model);
     ...
     * @param model 타겟 모델
     */
    void parseContextProperties(const xmlpp::Element *scxmlNode,
     ...
     * @param model 타겟 모델
     */
    void parseInjectPoints(const xmlpp::Element *scxmlNode, ::std::shared_ptr<::SCXML::Model::DocumentModel> model);
    ...
    void addSystemVariables(::std::shared_ptr<::SCXML::Model::DocumentModel> model);

    ::std::shared_ptr<::SCXML::Model::INodeFactory> nodeFactory_;
    ::std::shared_ptr<SCXML::Parsing::StateNodeParser> stateNodeParser_;
    ::std::shared_ptr<SCXML::Parsing::TransitionParser> transitionParser_;
    ::std::shared_ptr<SCXML::Parsing::ActionParser> actionParser_;
    ::std::shared_ptr<SCXML::Parsing::GuardParser> guardParser_;
