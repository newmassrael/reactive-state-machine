...
private:
    JSRuntime *runtime_;
    JSContext *context_;
    mutable std::mutex evaluation_mutex_;  // Ensures sequential JavaScript evaluation
    ...
    static JSValue inFunctionWrapper(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv);
    static JSValue consoleFunctionWrapper(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv);
    static JSValue nativeFunctionWrapper(JSContext *ctx, JSValueConst this_val, int argc, JSValueConst *argv);
};
